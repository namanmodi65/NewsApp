  ...
  render() {
    return (
      <div>
        ...
        <Navbar/>
        <Switch>
          <Route exact path="/"><News key="/" pageSize={6} country='in'/></Route>
          <Route exact path="/business"><News key="business" pageSize={6} country='in' category='business'/></Route>
          <Route exact path="/entertainment"><News key="entertariment" pageSize={6} country='in' category='entertainment'/></Route>
